        ...
        if($tenbinhluan==''|| $binhluan==''){
            $alert = "<span class='error'>Vui lòng nhập thông tin  </span>";
             ...
             $query = "INSERT INTO tbl_binhluan(tenbinhluan,binhluan,product_id) VALUES ('$tenbinhluan','$binhluan','$product_id')";
                ...
                if($result){
                    $alert="<span class ='success'>Comment thành công</span>";
                    return $alert;
                }else{
                     $alert="<span class ='error'>Chưa comment</span>";
                    return $alert;
                }
        }
    }
            ...
            return $alert;
                ...
                if($result){
                    ...
                    return $alert;
                     ...
                     $alert="<span class ='error'>Đăng kí chưa được</span>";
                    return $alert;
                }
            }
        }
            ...
            return $alert;
                ...
                if($result){
                    ...
                    return $alert;
                     ...
                     $alert="<span class ='error'> chưa cập nhật được</span>";
                    return $alert;
                }
            }
        }
