            ...
            <table class="form">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <textarea name="desc" class="tinymce"><?php echo$result_blog['description']?>
                    </textarea>
                    </td>
                </tr>
                 <tr>
                    ...
                    <td>
                        <textarea name="content" class="tinymce"><?php echo$result_blog['content']?>
                    </textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <img src="uploads/<?php echo $result_blog['image']?>"width="150" ><br>
