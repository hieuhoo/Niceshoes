        ...
        <div class="block">  
			...
			<tbody>
				...
				<tr class="odd gradeX">
					...
					<td><img src="uploads/<?php  echo $result_slider['slider_image']?>" height="100px" width="150px"/></td>			
					<td>
						<?php 
				...
				<td>
					...
					<a  href="?slider_del=<?php echo $result_slider['sliderId'] ?>" onclick="return confirm('Bạn có muốn xóa không !');" >Xóa</a> 
				</td>
					</tr>	
				<?php 
			}
