                 ...
                 ?>      
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td> <a href="customer.php?customerid=<?php echo $result['customer_id']?>&order_code=<?php echo $result['order_code']?>">Xem thông tin</a></td>
							<td>
								<?php
									if($result['status']==0){
						...
						?>
							...
							<a href="?delid=<?php echo $result['order_code']?>"> Xóa đơn hàng </a>
						<?php 
								}
