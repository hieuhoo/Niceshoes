...
<!DOCTYPE HTML>
<head>
<title>Https://NiceShoes.com </title>
									...
									<?php 
										$check_cart =$ct ->check_cart();
											if($check_cart){
												$sum= Session::get("sum");
													$qty= Session::get("qty");
												echo $fm->format_curency($sum).' '.'VND'.'-'.'SL:'.$qty ;
												}else{
													echo 'Trống';
												}
									 ?>
	  ...
	  <?php 
	  	$login_check =Session::get('customer_login');
	  				if($login_check==false){
	  					...
	  					echo '	  <li><a href="history_order.php">Đơn đã đặt</a> </li>';
	  				}
	   ?>
	    <?php 
			  $login_check = Session::get('customer_login');
	   ...
	   ?>
	    <?php 
			  ...
			  if($login_check){
	    			...
	    			echo'<li><a href="wishlist.php">Ưa thích</a> </li>';
			  }
